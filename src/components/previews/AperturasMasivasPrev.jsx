  ...
  return (
    <div className='flex flex-col gap-6 my-5'>
      ...
      <div className='text-blue-500'>
        <Link to="/aperturas-masivas" className='text-white hover:text-stone-500 bg-black py-3 px-4 rounded-md'>Ver mas</Link>
      </div>
...
export default AperturasMasivasPrev
