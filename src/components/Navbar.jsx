...
const Navbar = ({ user, setUser }) => {
  ...
  return (
    <nav className='flex justify-between items-center p-4 bg-white text-black border-b-1 border-stone-300 hover:border-blue-500 hover:transition-all duration-200 ease-in-out'>
      <div>
